...
overview: "Build a production-level React (Vite) application with a full generator-based JS interpreter, event loop simulator, and premium dark-themed UI across 6 pages: 1 landing, 4 educational, and 1 interactive visualizer."
todos:
  - id: phase1-scaffold
    content: "Phase 1: Initialize Vite + React + TS project, install all dependencies, configure Tailwind dark theme, set up React Router with 6 routes, create Layout shell"
    status: pending
  - id: phase2-design-system
    content: "Phase 2: Build shared UI components (GlassCard, Button, Badge, AnimatedBackground, Navbar, Footer, PageLayout) with premium dark aesthetic"
    status: pending
  - id: phase3-landing
    content: "Phase 3: Build Landing Page with hero section, animated background, feature cards, CTA button, scroll animations"
    status: pending
  - id: phase4-educational
    content: "Phase 4: Build 4 educational pages (About Runtime, Event Loop Deep Dive, Node vs Browser, Execution Examples) with animated diagrams and interactive demos"
    status: pending
  - id: phase5-engine
    content: "Phase 5: Build the full execution engine — types, acorn parser, environment/scope system, generator-based interpreter, event loop simulator, built-in APIs, prebuilt examples"
    status: pending
  - id: phase6-store
    content: "Phase 6: Build Zustand store for visualizer state (call stack, queues, console, playback controls, mode toggle)"
    status: pending
  - id: phase7-visualizer
    content: "Phase 7: Build Visualizer Page — all visual components (CallStack, WebAPIs, Queues, EventLoop animation, Console, Monaco Editor, Controls) with Framer Motion animations"
    status: pending
  - id: phase8-integration
    content: "Phase 8: Integration and polish — wire engine to store, connect playback controls, line highlighting, error handling, keyboard shortcuts, responsive layout, accessibility"
    status: pending
isProject: false
---
